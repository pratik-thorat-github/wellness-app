...
const BatchCheckoutBooking: React.FC<IClassCheckout> = ({}) => {
  ...
  const backBtn=()=>(
    <svg onClick={()=>navigate(-1)}xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
  <path d="M15.8327 9.99935H4.16602M4.16602 9.99935L9.99935 15.8327M4.16602 9.99935L9.99935 4.16602" stroke="#212121" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
  )

  const guestIcon=()=>(
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
  <path d="M12.6673 14V10M10.6673 12H14.6673M8.00065 10H5.33398C4.09147 10 3.47022 10 2.98016 10.203C2.32675 10.4736 1.80762 10.9928 1.53697 11.6462C1.33398 12.1362 1.33398 12.7575 1.33398 14M10.334 2.19384C11.3113 2.58943 12.0007 3.54754 12.0007 4.66667C12.0007 5.78579 11.3113 6.7439 10.334 7.13949M9.00065 4.66667C9.00065 6.13943 7.80674 7.33333 6.33398 7.33333C4.86123 7.33333 3.66732 6.13943 3.66732 4.66667C3.66732 3.19391 4.86123 2 6.33398 2C7.80674 2 9.00065 3.19391 9.00065 4.66667Z" stroke="#05070B" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
  )

  const incIcon=()=>(
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
  <path d="M8.00065 3.33398V12.6673M3.33398 8.00065H12.6673" stroke="#06080C" stroke-width="0.7" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
  )

  const dscIcon=()=>(
    <svg  className={noOfGuests<1 ? 'disabled':''} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    <path d="M3.33398 8H12.6673" stroke="#05070B" stroke-width="0.7" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
  )
  ...
  return (
    <>
      <div className="checkWrapper">
        ...
        <div
          className={
            batchDetails.guestsAllowed ? "offer offerGray" : "offer offerGreen"
          }
        >
          {batchDetails.guestsAllowed
            ? discountIconGray()
