...
const Onboarding: React.FC<Onboarding> = ({ setOnboarding }) => {
  ...
  const acitivities = (slide: number) => (
    <div className="obActWrap">
      <div>
        <span
          className={[0, 6, 12].includes(slide) ? "bold" : ""}
          style={{ color: "#9DD698" }}
        >
          {" "}
          Dance
        ...
        <span
          style={{ color: "#D69898" }}
          className={[2, 8, 14].includes(slide) ? "bold" : ""}
        >
          Badminton
        </span>
      </div>
      <div>
        <span
          style={{ color: "#D6CC98" }}
          className={[3, 9, 15].includes(slide) ? "bold" : ""}
        >
          Gym
        </span>
        <span
          style={{ color: "#9DD698" }}
          className={[1, 7, 13].includes(slide) ? "bold" : ""}
        >
          Yoga
        </span>
        <span
          style={{ color: "#989BD6" }}
          className={[4, 10, 16].includes(slide) ? "bold" : ""}
        >
          Boxing
        </span>
      </div>
      <div>
        <span
          style={{ color: "#D6CC98" }}
          className={[5, 11, 17].includes(slide) ? "bold" : ""}
        >
          Swimming{" "}
        </span>
  ...
  return (
    <>
      <div className="obacitivities">{acitivities(slide)}</div>
